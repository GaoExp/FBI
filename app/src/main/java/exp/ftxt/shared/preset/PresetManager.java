    ...
    public static boolean exportToFile(Activity activity, String filename) {
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= 29) {
                ...
                values.put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_DOWNLOADS + "/FBI");
                ...
                if (uri != null) {
                    ...
                    if (os != null) {
                        ...
                        writer.flush();
                        writer.close();
                        Toast.makeText(activity, "Diekspor ke Downloads/FBI/" + filename, Toast.LENGTH_SHORT).show();
                        return true;
                    }
                }
            } else {
